...
const (
	REGISTER IdRegisterEventType = "ID_REGISTER_EVENT_TYPE_REGISTER"
	TRANSFER IdRegisterEventType = "ID_REGISTER_EVENT_TYPE_TRANSFER"
	CHANGE_RECOVERY IdRegisterEventType = "ID_REGISTER_EVENT_TYPE_CHANGE_RECOVERY"
)
