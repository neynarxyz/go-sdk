...
type VerificationsAPI interface {
	...
	*/
	...
	// FetchVerificationsByFidExecute executes the request
	//  @return FetchVerificationsByFid200Response
	FetchVerificationsByFidExecute(r ApiFetchVerificationsByFidRequest) (*FetchVerificationsByFid200Response, *http.Response, error)
}
...
func (r ApiFetchVerificationsByFidRequest) Fid(fid int32) ApiFetchVerificationsByFidRequest {
	r.fid = &fid
	return r
}

// The optional ETH address to filter by
func (r ApiFetchVerificationsByFidRequest) Address(address string) ApiFetchVerificationsByFidRequest {
	r.address = &address
	return r
}

// Maximum number of messages to return in a single response
func (r ApiFetchVerificationsByFidRequest) PageSize(pageSize int32) ApiFetchVerificationsByFidRequest {
	r.pageSize = &pageSize
	return r
}

// Reverse the sort order, returning latest messages first
func (r ApiFetchVerificationsByFidRequest) Reverse(reverse bool) ApiFetchVerificationsByFidRequest {
	r.reverse = &reverse
	return r
}

// The page token returned by the previous query, to fetch the next page. If this parameter is empty, fetch the first page
func (r ApiFetchVerificationsByFidRequest) PageToken(pageToken string) ApiFetchVerificationsByFidRequest {
	r.pageToken = &pageToken
	return r
}

func (r ApiFetchVerificationsByFidRequest) Execute() (*FetchVerificationsByFid200Response, *http.Response, error) {
	return r.ApiService.FetchVerificationsByFidExecute(r)
}
