...
type FnameAPI interface {
	...
	*/
	...
	// IsFnameAvailableExecute executes the request
	//  @return FnameAvailabilityResponse
	IsFnameAvailableExecute(r ApiIsFnameAvailableRequest) (*FnameAvailabilityResponse, *http.Response, error)
}
...
func (r ApiIsFnameAvailableRequest) Execute() (*FnameAvailabilityResponse, *http.Response, error) {
	return r.ApiService.IsFnameAvailableExecute(r)
}
