...
func (o *User) GetVerifiedAccounts() []UserVerifiedAccountsInner {
	if o == nil {
		var ret []UserVerifiedAccountsInner
		return ret
	}
...
// GetVerifiedAccountsOk returns a tuple with the VerifiedAccounts field value
// and a boolean to check if the value has been set.
...
// SetVerifiedAccounts sets field value
...
// SetExperimental gets a reference to the given UserExperimental and assigns it to the Experimental field.
