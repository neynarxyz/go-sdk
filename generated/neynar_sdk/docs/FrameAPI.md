...
func main() {
	...
	fids := "194, 191, 6131" // string | Comma separated list of FIDs, up to 100 at a time. If you pass in FIDs, you will get back all the notification tokens for those FIDs. If you don't pass in FIDs, you will get back all the notification tokens for the mini app. (optional)
	cursor := "cursor_example" // string | Pagination cursor (optional)
 ...
 **fids** | **string** | Comma separated list of FIDs, up to 100 at a time. If you pass in FIDs, you will get back all the notification tokens for those FIDs. If you don&#39;t pass in FIDs, you will get back all the notification tokens for the mini app. | 
 **cursor** | **string** | Pagination cursor | 
