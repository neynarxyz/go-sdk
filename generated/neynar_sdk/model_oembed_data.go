...
// checks if the OembedData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OembedData{}
...
func (o OembedData) ToMap() (map[string]interface{}, error) {
...
func (o *OembedData) UnmarshalJSON(data []byte) (err error) {
	...
	varOembedData := _OembedData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOembedData)

	if err != nil {
		return err
	}

	*o = OembedData(varOembedData)

	return err
}

type NullableOembedData struct {
	value *OembedData
	isSet bool
}

func (v NullableOembedData) Get() *OembedData {
	return v.value
}

func (v *NullableOembedData) Set(val *OembedData) {
	v.value = val
	v.isSet = true
}

func (v NullableOembedData) IsSet() bool {
	return v.isSet
}

func (v *NullableOembedData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOembedData(val *OembedData) *NullableOembedData {
	return &NullableOembedData{value: val, isSet: true}
}

func (v NullableOembedData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOembedData) UnmarshalJSON(src []byte) error {
	v.isSet = true
