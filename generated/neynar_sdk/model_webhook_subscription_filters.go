...
func (o *WebhookSubscriptionFilters) GetCastCreated() WebhookSubscriptionFiltersCast {
	if o == nil || IsNil(o.CastCreated) {
		var ret WebhookSubscriptionFiltersCast
		return ret
	}
...
// SetCastCreated gets a reference to the given WebhookSubscriptionFiltersCast and assigns it to the CastCreated field.
func (o *WebhookSubscriptionFilters) SetCastCreated(v WebhookSubscriptionFiltersCast) {
	o.CastCreated = &v
}

// GetCastDeleted returns the CastDeleted field value if set, zero value otherwise.
func (o *WebhookSubscriptionFilters) GetCastDeleted() WebhookSubscriptionFiltersCast {
	if o == nil || IsNil(o.CastDeleted) {
		var ret WebhookSubscriptionFiltersCast
		return ret
	}
	return *o.CastDeleted
}

// GetCastDeletedOk returns a tuple with the CastDeleted field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WebhookSubscriptionFilters) GetCastDeletedOk() (*WebhookSubscriptionFiltersCast, bool) {
	if o == nil || IsNil(o.CastDeleted) {
		return nil, false
	}
	return o.CastDeleted, true
}
...
// SetCastDeleted gets a reference to the given WebhookSubscriptionFiltersCast and assigns it to the CastDeleted field.
...
func (o WebhookSubscriptionFilters) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CastDeleted) {
		toSerialize["cast.deleted"] = o.CastDeleted
	}
