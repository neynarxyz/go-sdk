...
type InfoAPI interface {
	...
	*/
	...
	// LookupHubInfoExecute executes the request
	//  @return HubInfoResponse
	LookupHubInfoExecute(r ApiLookupHubInfoRequest) (*HubInfoResponse, *http.Response, error)
}
...
func (r ApiLookupHubInfoRequest) Dbstats(dbstats bool) ApiLookupHubInfoRequest {
	r.dbstats = &dbstats
	return r
}

func (r ApiLookupHubInfoRequest) Execute() (*HubInfoResponse, *http.Response, error) {
	return r.ApiService.LookupHubInfoExecute(r)
}
