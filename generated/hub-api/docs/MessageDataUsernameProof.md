...
`func NewMessageDataUsernameProof(type_ MessageType, fid int32, timestamp int64, network FarcasterNetwork, usernameProofBody UserNameProof, ) *MessageDataUsernameProof`
