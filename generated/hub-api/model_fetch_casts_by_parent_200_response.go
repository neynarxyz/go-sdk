...
// checks if the FetchCastsByParent200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FetchCastsByParent200Response{}

// FetchCastsByParent200Response struct for FetchCastsByParent200Response
type FetchCastsByParent200Response struct {
...
type _FetchCastsByParent200Response FetchCastsByParent200Response
...
func NewFetchCastsByParent200Response(nextPageToken string, messages []CastAdd) *FetchCastsByParent200Response {
	this := FetchCastsByParent200Response{}
...
func (o FetchCastsByParent200Response) ToMap() (map[string]interface{}, error) {
...
func (o *FetchCastsByParent200Response) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varFetchCastsByParent200Response)

	if err != nil {
		return err
	}

	*o = FetchCastsByParent200Response(varFetchCastsByParent200Response)

	return err
}

type NullableFetchCastsByParent200Response struct {
	value *FetchCastsByParent200Response
	isSet bool
}

func (v NullableFetchCastsByParent200Response) Get() *FetchCastsByParent200Response {
	return v.value
}

func (v *NullableFetchCastsByParent200Response) Set(val *FetchCastsByParent200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFetchCastsByParent200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFetchCastsByParent200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFetchCastsByParent200Response(val *FetchCastsByParent200Response) *NullableFetchCastsByParent200Response {
	return &NullableFetchCastsByParent200Response{value: val, isSet: true}
}

func (v NullableFetchCastsByParent200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFetchCastsByParent200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
