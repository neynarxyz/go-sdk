...
const (
	...
	AUDIO EmbedType = "audio"
	TEXT_HTML EmbedType = "text/html"
	TEXT_PLAIN EmbedType = "text/plain"
	IMAGE_JPEG EmbedType = "image/jpeg"
	IMAGE_PNG EmbedType = "image/png"
	IMAGE_GIF EmbedType = "image/gif"
	IMAGE_WEBP EmbedType = "image/webp"
	IMAGE_SVGXML EmbedType = "image/svg+xml"
	IMAGE_HEIF EmbedType = "image/heif"
	VIDEO_MP4 EmbedType = "video/mp4"
	VIDEO_QUICKTIME EmbedType = "video/quicktime"
	AUDIO_MPEG EmbedType = "audio/mpeg"
	APPLICATION_PDF EmbedType = "application/pdf"
	APPLICATION_JSON EmbedType = "application/json"
	APPLICATION_X_MPEGURL EmbedType = "application/x-mpegurl"
)
