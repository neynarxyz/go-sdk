...
const (
	SIGNER_EVENT_TYPE_ADD SignerEventType = "SIGNER_EVENT_TYPE_ADD"
	SIGNER_EVENT_TYPE_REMOVE SignerEventType = "SIGNER_EVENT_TYPE_REMOVE"
	SIGNER_EVENT_TYPE_ADMIN_RESET SignerEventType = "SIGNER_EVENT_TYPE_ADMIN_RESET"
)
