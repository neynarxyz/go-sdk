...
// List of MessageType
const (
	MESSAGETYPE_MESSAGE_TYPE_CAST_ADD                     MessageType = "MESSAGE_TYPE_CAST_ADD"
	MESSAGETYPE_MESSAGE_TYPE_CAST_REMOVE                  MessageType = "MESSAGE_TYPE_CAST_REMOVE"
	MESSAGETYPE_MESSAGE_TYPE_REACTION_ADD                 MessageType = "MESSAGE_TYPE_REACTION_ADD"
	MESSAGETYPE_MESSAGE_TYPE_REACTION_REMOVE              MessageType = "MESSAGE_TYPE_REACTION_REMOVE"
	MESSAGETYPE_MESSAGE_TYPE_LINK_ADD                     MessageType = "MESSAGE_TYPE_LINK_ADD"
	MESSAGETYPE_MESSAGE_TYPE_LINK_REMOVE                  MessageType = "MESSAGE_TYPE_LINK_REMOVE"
	MESSAGETYPE_MESSAGE_TYPE_VERIFICATION_ADD_ETH_ADDRESS MessageType = "MESSAGE_TYPE_VERIFICATION_ADD_ETH_ADDRESS"
	MESSAGETYPE_MESSAGE_TYPE_VERIFICATION_REMOVE          MessageType = "MESSAGE_TYPE_VERIFICATION_REMOVE"
	MESSAGETYPE_MESSAGE_TYPE_USER_DATA_ADD                MessageType = "MESSAGE_TYPE_USER_DATA_ADD"
	MESSAGETYPE_MESSAGE_TYPE_USERNAME_PROOF               MessageType = "MESSAGE_TYPE_USERNAME_PROOF"
	MESSAGETYPE_MESSAGE_TYPE_FRAME_ACTION                 MessageType = "MESSAGE_TYPE_FRAME_ACTION"
)
